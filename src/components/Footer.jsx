      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              <li><a href="#" className="hover:text-brand-400">Cloud Solutions</a></li>
              <li><a href="#" className="hover:text-brand-400">Cybersecurity</a></li>
              <li><a href="#" className="hover:text-brand-400">Web Development</a></li>
              <li><a href="#" className="hover:text-brand-400">App Development</a></li>
            </ul>
          </div>
